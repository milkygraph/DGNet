...
RUN pip3 install jittor --timeout 100 && python3.8 -m jittor.test.test_example
...
RUN python3.8 -m jittor.test.test_example

CMD python3.8 -m jittor.notebook --allow-root --ip=0.0.0.0
